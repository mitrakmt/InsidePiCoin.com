export const article = {
  ...
  description:
    'Discover how Pi Coin compares to Bitcoin and Ethereum with its unique mobile mining, community-driven distribution, and focus on everyday use. Explore the differences in mining, consensus, supply, and usability in this insightful comparison of Pi Network's cryptocurrency to traditional digital currencies.',
  author: {
